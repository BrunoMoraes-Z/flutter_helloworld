...
import 'package:hello_world/components/loading.dart';
import 'package:hello_world/models/Issue.dart';
import 'package:hello_world/models/OwnerRepository.dart';
...
class _DetailsPageState extends State<DetailsPage> {
  _DetailsPageState() {
    ...
    Future.delayed(Duration(seconds: 1), () {
      GetIssues(
        'https://api.github.com/repos/${widget.repository.fullName}/issues',
      );
    });
  }
